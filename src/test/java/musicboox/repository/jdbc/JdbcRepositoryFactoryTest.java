...
public class JdbcRepositoryFactoryTest {
  ...
  public void testGetInstance() throws Exception {
    //Given
    JdbcRepositoryFactory jdbcRepositoryFactory2 = 
        JdbcRepositoryFactory.getInstance(jdbcConfiguration);
    //Then
  ...
  public void testGetPieceRepository() throws Exception {
    ...
    JdbcConnectionFactory jdbConnectionFactory = 
        ((JdbcPieceRepositoryImpl)pieceRepository).getJdbcConnectionFactory();
    assertThat(jdbcConfiguration, 
        equalsExpectedJdbcConfiguration(jdbConnectionFactory.getJdbcConfiguration()));
  }
  ...
  public void testGetComposerRepository() throws Exception {
    ...
    JdbcConnectionFactory jdbConnectionFactory = 
        ((JdbcComposerRepositoryImpl)composerRepository).getJdbcConnectionFactory();
    assertThat(jdbcConfiguration, 
        equalsExpectedJdbcConfiguration(jdbConnectionFactory.getJdbcConfiguration()));
